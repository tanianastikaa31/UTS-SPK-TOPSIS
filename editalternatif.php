    ...
    <nav class="navbar navbar-default navbar-custom">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Seleksi Penerima Beasiswa metode TOPSIS</a>
        </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form class="form" action="edita.php" method="post">
                    ...
                    <div class="form-group">
                      <input class="form-control" type="text" name="jenis_kelamin" value= <?php echo $jenis_kelamin; ?> >
                    </div>
                    <div class="form-group">
