  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-custom">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="kriteria.php">Seleksi Penerima Beasiswa metode TOPSIS</a>
        </div>
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
              <a href="hasiltopsis.php">Hasil Topsis</a>
            </li>
          </ul>
        </div>
      </div>
                      ...
                      <div class="">
                        ...
                        <form class="form" action="alternatiftambah.php" method="post">
                          <div class="form-group">
                            <input class="form-control" type="text" name="id_alter" placeholder="Kode Alternatif">
                          </div>
                          <div class="form-group">
    ...
    if (isset($_POST['simpan'])) {
      ...
      if ($row = $tambah->fetch_row()) {
        $masuk = "INSERT INTO tab_alternatif VALUES ('".$id_alter."','".$alternatif."','".$alamat."','".$jenis_kelamin."')";
